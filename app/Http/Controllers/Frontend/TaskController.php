...
class TaskController extends Controller
{
    ...
    public function index()
    {
        ...
        $tasks = Task::with(['job', 'status', 'tags', 'assigned_to', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('frontend.tasks.create', compact('assigned_tos', 'jobs', 'statuses', 'tags'));
    }
    ...
    public function edit(Task $task)
    {
        ...
        $task->load('job', 'status', 'tags', 'assigned_to');

        return view('frontend.tasks.edit', compact('assigned_tos', 'jobs', 'statuses', 'tags', 'task'));
    }
