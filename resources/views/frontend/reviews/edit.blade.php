                    ...
                    <form method="POST" action="{{ route("frontend.reviews.update", [$review->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Review::RATING_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="rating_{{ $key }}" name="rating" value="{{ $key }}" {{ old('rating', $review->rating) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="comment" id="comment">{!! old('comment', $review->comment) !!}</textarea>
