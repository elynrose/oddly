    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bids.update", [$bid->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="bid_amount" id="bid_amount" value="{{ old('bid_amount', $bid->bid_amount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="points_required" id="points_required" value="{{ old('points_required', $bid->points_required) }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="featured" id="featured" value="1" {{ $bid->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="highlighted" id="highlighted" value="1" {{ $bid->highlighted || old('highlighted', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="free" id="free" value="1" {{ $bid->free || old('free', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="selected" id="selected" value="1" {{ $bid->selected || old('selected', 0) === 1 ? 'checked' : '' }}>
