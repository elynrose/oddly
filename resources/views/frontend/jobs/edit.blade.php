                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.jobs.update", [$job->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $job->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $job->description) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="deadline" id="deadline" value="{{ old('deadline', $job->deadline) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="completed_link" id="completed_link" value="{{ old('completed_link', $job->completed_link) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="published" id="published" value="1" {{ $job->published || old('published', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_code" id="job_code" value="{{ old('job_code', $job->job_code) }}" required>
