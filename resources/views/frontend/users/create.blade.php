                    ...
                    <form method="POST" action="{{ route("frontend.users.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="free_post_used" id="free_post_used" value="1" {{ old('free_post_used', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="paid_for_first_bid" id="paid_for_first_bid" value="1" {{ old('paid_for_first_bid', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="has_first_review" id="has_first_review" value="1" {{ old('has_first_review', 0) == 1 ? 'checked' : '' }}>
