    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.jobs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('completed_link') ? 'is-invalid' : '' }}" type="text" name="completed_link" id="completed_link" value="{{ old('completed_link', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('job_code') ? 'is-invalid' : '' }}" type="text" name="job_code" id="job_code" value="{{ old('job_code', '') }}" required>
