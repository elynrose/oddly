                ...
                <tbody>
                    @foreach($users as $key => $user)
                        <tr data-entry-id="{{ $user->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $user->free_post_used ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $user->free_post_used ? 'checked' : '' }}>
                            </td>
                            <td>
                                <span style="display:none">{{ $user->paid_for_first_bid ?? '' }}</span>
                                <input type="checkbox" disabled="disabled" {{ $user->paid_for_first_bid ? 'checked' : '' }}>
                            </td>
                            <td>
                                <span style="display:none">{{ $user->has_first_review ?? '' }}</span>
