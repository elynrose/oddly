...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('free_post_used') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="free_post_used" value="0">
                    <input class="form-check-input" type="checkbox" name="free_post_used" id="free_post_used" value="1" {{ $user->free_post_used || old('free_post_used', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="free_post_used">{{ trans('cruds.user.fields.free_post_used') }}</label>
                </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('paid_for_first_bid') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="paid_for_first_bid" value="0">
                    <input class="form-check-input" type="checkbox" name="paid_for_first_bid" id="paid_for_first_bid" value="1" {{ $user->paid_for_first_bid || old('paid_for_first_bid', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="paid_for_first_bid">{{ trans('cruds.user.fields.paid_for_first_bid') }}</label>
                </div>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('has_first_review') ? 'is-invalid' : '' }}">
                    <input type="hidden" name="has_first_review" value="0">
                    <input class="form-check-input" type="checkbox" name="has_first_review" id="has_first_review" value="1" {{ $user->has_first_review || old('has_first_review', 0) === 1 ? 'checked' : '' }}>
                    <label class="form-check-label" for="has_first_review">{{ trans('cruds.user.fields.has_first_review') }}</label>
                </div>
