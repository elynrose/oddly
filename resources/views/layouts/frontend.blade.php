                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @endcan
                                    @can('budget_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.budgets.index') }}">
                                    ...
                                    @endcan
                                    @can('job_access')
                                        <a class="dropdown-item" href="{{ route('frontend.jobs.index') }}">
                                            {{ trans('cruds.job.title') }}
                                        </a>
                                    @endcan
                                    @can('bid_access')
                                        <a class="dropdown-item" href="{{ route('frontend.bids.index') }}">
